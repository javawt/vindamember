...
import com.songlanyun.jymall.common.utils.MD5Util;
...
public class PayCommonUtil {
    ...
    @Autowired
    public static WxUtil staticWxUtil;
    ...
    public static boolean isTenpaySign(Map<String, String> map) {
     ...
     //过滤空 设置 TreeMap
       ...
       sb.append("key=" + staticWxUtil.getPayKey());
    ...
    public static String httpsRequest2(String requestUrl, String requestMethod, String outputStr) throws Exception {  
          ...
          SSLContext sslcontext = SSLContexts.custom()
                  .loadKeyMaterial(keyStore, "1321862301".toCharArray())  
                  .build();  
